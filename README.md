...
- `src/components/TeamCard/index.jsx`
- `src/components/TeamCard/index.css`
- `src/components/TeamMatches/index.jsx`
- `src/components/TeamMatches/index.css`
- `src/components/LatestMatch/index.jsx`
- `src/components/LatestMatch/index.css`
- `src/components/MatchCard/index.jsx`
...
- In order to display the given animated loader, pass the `size` and `color` props to the `ClipLoader` component with given values.
